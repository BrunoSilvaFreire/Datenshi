...
public partial class GameEntity {
    ...
    public Datenshi.Scripts.Entities.Components.ViewComponent view { get { return (Datenshi.Scripts.Entities.Components.ViewComponent)GetComponent(GameComponentsLookup.View); } }
    public bool hasView { get { return HasComponent(GameComponentsLookup.View); } }

    public void AddView(Entitas.Unity.EntityLink newView) {
        var index = GameComponentsLookup.View;
        var component = CreateComponent<Datenshi.Scripts.Entities.Components.ViewComponent>(index);
        component.View = newView;
        AddComponent(index, component);
    }

    public void ReplaceView(Entitas.Unity.EntityLink newView) {
        var index = GameComponentsLookup.View;
        var component = CreateComponent<Datenshi.Scripts.Entities.Components.ViewComponent>(index);
        component.View = newView;
